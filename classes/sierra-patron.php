...
class sierraPatron
{
    ...
    private function populatePatronData($patronBarcode) {
        ...
        $uri .= '&fields=id,names,birthDate,barcodes,addresses,phones,emails,expirationDate,patronType';
        ...
        $this->patronTypeCode = $result->patronType;
    }
    ...
    public function getPatronTypeCode() {
        return $this->patronTypeCode;
    }
