...
<label class="bento-label" for="tab2">Books/<?php echo localeStrings::translate($config->getLocale(),"Catalog"); ?></label>
...
<div id="content1" class="bento-section">
    <?php include "content-bento-searchbox-quick-search.php" ?>
</div>

<div id="content2" class="bento-section">
    <?php include "content-bento-searchbox-catalog.php" ?>
</div>

<div id="content3" class="bento-section">
    <?php include "content-bento-searchbox-databases.php" ?>
</div>

<div id="content4" class="bento-section">
    <?php include "content-bento-searchbox-digital-archives.php" ?>
</div>
