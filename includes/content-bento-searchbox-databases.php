...
<form id="DB-search-form" name="DB-search-form" method="get" action="https://<?php echo $config->getDB() ?>/search/?searchtype=m">
    <fieldset class="bento-fieldset">
        ...
        <select name="searcharg">
            <option value="african american african studies" selected="">African Studies</option>
        ...
        <button type="submit" id="db-subject-browse-button" class="btn btn-primary search-button">
            Browse</button>
        <br>
        <br>
