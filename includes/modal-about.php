        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav active"><a href="#aboutTheLibrary" class="font-weight-bold" data-toggle="tab">About the Library</a></li>
                    <li class="nav"><a href="#technical" class="font-weight-bold" data-toggle="tab">Technical</a></li>
                </ul>
            ...
            <div class="modal-footer my-modal-footer">
                <span style="color: black">29999000000001     20600000013391</span>
