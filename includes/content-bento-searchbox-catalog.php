<h3>Books/<?php echo localeStrings::translate($config->getLocale(),"Catalog"); ?></h3>
<br>
<form method="get" action="https://<?php echo $config->getDB() ?>/search/" name="classic-search-form" id="classic-search-form" target="_self">
    <fieldset class="bento-fieldset">
        ...
        <input id="classic-search-input" name="searcharg" size="20" maxlength="60" type="text"  placeholder="Browse the <?php echo localeStrings::translate($config->getLocale(),"Catalog"); ?>" required>
        <input name="SORT" value="D" type="hidden">
        <input type="submit" value="Search" class="btn btn-primary search-button" id="classic-search-button">
    </fieldset>
</form>
<br>
