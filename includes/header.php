...
// only include the To Do Modal if the config setting says to
if ($config->getSupportToDoList() == true) {
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            // the hyperlink depending on whether we're supporting the to-do list or not.
            if ($config->getSupportToDoList() == true) {
                echo ' href="#" data-toggle="modal" data-backdrop="static" data-target="#todoModal"';
            } else {
                echo ' href="index.php"';
            }

            // the class is the same no matter what
            echo ' class="navbar-brand">';

            // the brand logo depending on whether it's an image or a faux logo
            if ($config->getLogoFileName() == '') {
                echo '<span><img src="/images/red-flame.png">' . $config->getInstitutionName() . '</span>';
            } else {
                echo '<img class="img-responsive" id="img-logo" src="' . $config->getLogoFileName() . '">';
            }
            echo '</a>'
           ?>
        </div>
        ...
        <div class="collapse navbar-collapse" id="balboa-menu">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <?php if (isset($_SESSION['barcode'])) {
                    ...
                    echo '><a href="login.php"><span class="glyphicon glyphicon-user"></span> Login/Register</a></li>';
                }
                ?>
            </ul>
        </div><!-- /.navbar-collapse -->
