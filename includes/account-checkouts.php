...
if (isset($_SESSION["itemsRenewed"])) {
    $alertMessage = $_SESSION["itemsRenewed"] . " item(s) renewed. <small><a href='#' data-toggle='tooltip' data-placement='right' title='There are conditions under which some or all of your items may not be renewed. For example, you may have fines and fees that block your renewals. In addition, your library places a limit on how many times a given type of item may be renewed. Check with library staff if you have concerns or questions.'>more...</a></small>";
...
$checkoutData = new sierraPatronCheckoutsExpanded($config,$_SESSION['patronId']);
