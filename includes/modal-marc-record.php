    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-striped table-responsive table-marc">
                    <tbody>
                    <?php
                    ...
                    echo '<tr>';
                    echo '<td><strong>LDR</strong></td><td></td><td>' . $marc_array['leader'] . '</td>';
                    echo '</tr>';
                    ...
                    foreach ($marc_array['fields'] as $thisTag) {
                        foreach ($thisTag as $tagNumber => $tagData) {
                            ...
                            echo '<td><strong>' . $tagNumber . '</strong></td>';
                            ...
                            if (!is_array($tagData)) {
                                ...
                                foreach ($tagData['subfields'] as $thisSubfield) {
                                    foreach ($thisSubfield as $subfieldCode => $subfieldData) {
                                        echo '<span class="text-success">$' . $subfieldCode . '</span> ' . htmlentities($subfieldData);
                                    }
                                }
                                echo '</td>';
                            }
