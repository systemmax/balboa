...
function sendEmail() {
    ...
    $thisMessage = "Below is a comment from a " . $config->getInstitutionName()  . " user:" . "<br><br>" .
        "Username: " . $name . "<br>" .
        "Email: " . $userEmail . "<br>" .
        "Requests a response:  " . $reply . "<br>" .
        "Comment: " . "<br>" .
        $_POST["comment"];

    include "classes/kellsmail.php";
    $contactEmail = new kellsmail($config->getInstitutionName() . " Contact Form",$thisMessage);
