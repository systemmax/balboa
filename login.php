...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $loggedPatron = new sierraPatron($config,$_POST["barcode"],$_POST["pin"]);
    if ($loggedPatron->isValidPatron() == true) {
        // purge old serialized patron data (not just for this patron. for all)
        $loggedPatron->purgeExpiredCacheData();
        ...
        $_SESSION['patronEmail'] = $loggedPatron->getFirstEmail(); // use the first email in the record.
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    ...
                    <button id="clear" name="clear" type="button" class="btn btn-danger" onclick="window.history.back();">Cancel</button> &nbsp; &nbsp; New to the library? <a href="registration.php">Click here.</a>
                </div>
            </div>
